...
export default class BoatMap extends LightningElement {
  ...
  set recordId(value) {
    ...
    console.log('setter:::', this.boatId);
    this.boatId = value;
    console.log('setter:::', this.boatId);
  ...
  wiredRecord({ error, data }) {
    // Error handling
    if (data) {
      console.log('from getRecord:::', data);
      ...
      console.error('from getRecord:::', error);
      this.error = error;
  ...
  handleMessage(message) {
    ...
    console.log('recrodId from MC:::', this.boatId);
  ...
  getBoatLocation() {
    getBoatLocation({ boatId: this.boatId })
      .then((result) => {
        console.log('boat location:::', result);
